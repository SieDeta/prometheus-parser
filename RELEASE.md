...
If you are interested in volunteering please create a pull request against the [prometheus/prometheus](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches) repository and propose yourself for the release series of your choice.
...
These instructions are currently valid for the Prometheus server, i.e. the [prometheus/prometheus repository](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches). Applicability to other Prometheus repositories depends on the current state of each repository. We aspire to unify the release procedures as much as possible.
...
Check the [dependencies GitHub label](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/labels/dependencies) to see if there are any pending updates.
...
> NOTE: As a validation step check if all security alerts are closed after this step: https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/security/dependabot. Sometimes it's ok
