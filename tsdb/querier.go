...
func PostingsForMatchers(ctx context.Context, ix IndexReader, ms ...*labels.Matcher) (index.Postings, error) {
	...
	for _, m := range ms {
		...
		default: // l=""
			...
			// https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/3575 and
			// https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/pull/3578#issuecomment-351653555
