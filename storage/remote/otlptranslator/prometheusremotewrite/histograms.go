...
package prometheusremotewrite // import "github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/storage/remote/otlptranslator/prometheusremotewrite"
...
func exponentialToNativeHistogram(p pmetric.ExponentialHistogramDataPoint) (prompb.Histogram, error) {
	...
	h := prompb.Histogram{
		...
		// Counter reset detection in Prometheus: https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/blob/f997c72f294c0f18ca13fa06d51889af04135195/tsdb/chunkenc/histogram.go#L232
