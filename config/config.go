...
import (
	...
	"github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/storage/remote/azuread"
)
...
func Load(s string, expandExternalLabels bool, logger log.Logger) (*Config, error) {
	...
	*cfg = DefaultConfig
	...
	cfg.GlobalConfig.ExternalLabels.Range(func(v labels.Label) {
		...
		// Note newV can be blank. https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/11024
		b.Add(v.Name, newV)
	})
