...
Their behaviour can change in future releases which will be communicated via the [release changelog](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/blob/main/CHANGELOG.md).
