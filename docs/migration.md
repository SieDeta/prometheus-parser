...
You will need to use `promtool` from [Prometheus 2.5](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/releases/tag/v2.5.0) as later versions no longer contain the above subcommand.
...
See [issue #3060](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/3060) for more
details.
...
as a non-root user](https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/pull/2859). If you
