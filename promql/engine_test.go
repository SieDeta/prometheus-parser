...
`)
	...
	// To test the fix for https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/8433.
	...
	cases := []struct {
		...
		{ // Time of the result is the evaluation time.
			...
			// Tests for https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/8433.
