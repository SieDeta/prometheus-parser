...
func TestDeriv(t *testing.T) {
	// https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/2674#issuecomment-315439393
	...
	// https://github.com/zzylol/prometheus-sketch-VLDB/prometheus-sketches/issues/7180
	for i = 0; i < 15; i++ {
		jitter := 12 * i % 2
